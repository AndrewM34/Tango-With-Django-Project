...
def about(request):
	...
	visitor_cookie_handler(request)
	return render(request, 'rango/about.html', context={'visits': int(request.COOKIES.get('visits', 1))})
...
def visitor_cookie_handler(request):
	...
	if (datetime.now()-last_visit_time).days > 0: # more than 1 day since last visit
		visits = visits + 1	
